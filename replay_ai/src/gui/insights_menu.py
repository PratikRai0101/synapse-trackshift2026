...
class InsightsMenu(QMainWindow):
    ...
    def setup_ui(self):
        ...
        content_layout.addWidget(self.create_category_section(
            "Race Engineer",
            [
                ("Energy & Overtake Intelligence", "Estimated SoC, energy flow and overtake risk-reward per driver", self.launch_race_engineer),
            ]
        ))
    ...
    def launch_race_engineer(self):
        print("🚀 Launching: Race Engineer — Energy & Overtake Intelligence")
        from src.insights.race_engineer_window import RaceEngineerWindow
